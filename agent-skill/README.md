...
It can be used to answer almost 90% of any questions you would have about spydra. We tested it on [OpenClaw](https://github.com/openclaw/openclaw) and [Claude Code](https://claude.com/product/claude-code), but please open a [ticket](https://github.com/D4Vinci/Spydra/issues/new/choose) if you faced any issues or use our [Discord server](https://discord.gg/EMgGbDceNQ).

## Installation

You can use this [direct URL](https://github.com/D4Vinci/Spydra/raw/refs/heads/main/agent-skill/Spydra-Skill.zip) to download the ZIP file of the skill directly. We will try to update this page with all available methods.
...
```bash
clawhub install spydra-official
```

Or go to the [Clawhub](https://docs.openclaw.ai/tools/clawhub) page from [here](https://clawhub.ai/D4Vinci/spydra-official).