...
from spydra.core.utils import log
from spydra.spiders.scheduler import Scheduler
from spydra.spiders.session import SessionManager
from spydra.spiders.request import Request, Response
from spydra.spiders.robotstxt import RobotsTxtManager
from spydra.spiders.result import CrawlStats, ItemList
from spydra.spiders.cache import ResponseCacheManager
from spydra.spiders.checkpoint import CheckpointManager, CheckpointData
from spydra.core._types import Dict, Union, Optional, TYPE_CHECKING, Any, AsyncGenerator
...
class CrawlerEngine:
    ...
    def __init__(
        ...
        if self.spider.development_mode:
            cache_dir = self.spider.development_cache_dir or f".spydra_cache/{self.spider.name}"
