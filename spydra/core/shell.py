...
from spydra import __version__
from spydra.core.utils import log
from spydra.parser import Selector, Selectors
from spydra.core.custom_types import TextHandler
from spydra.engines.toolbelt.custom import Response
from spydra.core.utils._shell import _ParseHeaders, _CookieParser
...
class CurlParser:
    ...
    def __init__(self) -> None:
        from spydra.fetchers import Fetcher as __Fetcher
