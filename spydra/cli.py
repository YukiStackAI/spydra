...
from spydra.core.utils._shell import _CookieParser, _ParseHeaders
from spydra.core._types import List, Optional, Dict, Tuple, Any, Callable
...
def shell(code, level):
    from spydra.core.shell import CustomShell
