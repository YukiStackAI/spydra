...
from spydra.engines.toolbelt.proxy_rotation import ProxyRotator
from spydra.engines.toolbelt.navigation import construct_proxy_dict
from spydra.engines._browsers._types import PlaywrightFetchParams, StealthFetchParams
...
class PlaywrightConfig(Struct, kw_only=True, frozen=False, weakref=True):
    ...
    def __post_init__(self):  # pragma: no cover
        ...
        if self.block_ads:
            from spydra.engines.toolbelt.ad_domains import AD_DOMAINS
