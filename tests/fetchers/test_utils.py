...
from spydra.engines.toolbelt.custom import StatusText, Response
...
from spydra.engines.toolbelt.fingerprints import get_os_name, generate_headers
...
class TestBlockAdsConfig:
    ...
    def test_block_ads_populates_blocked_domains(self):
        from spydra.engines._browsers._validators import PlaywrightConfig
