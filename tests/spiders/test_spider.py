...
from spydra.spiders.spider import Spider, SessionConfigurationError, LogCounterHandler, BLOCKED_CODES
from spydra.spiders.request import Request
from spydra.spiders.session import SessionManager
from spydra.spiders.result import CrawlStats
from spydra.core._types import Any, Dict, AsyncGenerator
...
class TestSpiderInit:
    ...
    def test_spider_initializes_logger(self):
        ...
        assert spider.logger.name == "spydra.spiders.test_spider"
